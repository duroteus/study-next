  ...
  describe("Default user", () => {
    ...
    test("With nonexistent session", async () => {
      const nonExistentToken =
        "6ee46c2660adc7562b6b074e86bc34067306021c57673242e32f7a71b516d48e9f52b1c06adb72210d06d545d406dfbe";
      const response = await fetch("http://localhost:3000/api/v1/user", {
        headers: {
    ...
    test("With expired session", async () => {
      jest.useFakeTimers({
        now: new Date(Date.now() - session.EXPIRATION_IN_MILISECONDS - 1),
      });
